...
This packet is the feature-level execution record. Its authoritative dependency order, pass catalog, and acceptance criteria are maintained in `SIMULATOR_RETIREMENT_READINESS_EXECUTION_ROADMAP.md` under F00.

## Planned Passes

1. F00.1, F00.2.
2. Primary areas: Architecture and integration evidence.
