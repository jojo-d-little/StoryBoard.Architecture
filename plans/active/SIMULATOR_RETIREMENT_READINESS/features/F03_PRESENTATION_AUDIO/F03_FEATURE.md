...
This packet is the feature-level execution record. Its authoritative dependency order, pass catalog, and acceptance criteria are maintained in `SIMULATOR_RETIREMENT_READINESS_EXECUTION_ROADMAP.md` under F03.

## Planned Passes

1. F03.1 through F03.6.
2. Primary areas: Host/Engine, WebPortal, Simulator audit, and integration.
