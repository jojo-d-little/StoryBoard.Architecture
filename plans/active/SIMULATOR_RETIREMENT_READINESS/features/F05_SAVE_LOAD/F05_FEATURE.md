...
This packet is the feature-level execution record. Its authoritative dependency order, pass catalog, and acceptance criteria are maintained in `SIMULATOR_RETIREMENT_READINESS_EXECUTION_ROADMAP.md` under F05.

## Planned Passes

1. F05.1 through F05.5.
2. Primary areas: Host/Engine, WebPortal, Designer, and Simulator audit.
