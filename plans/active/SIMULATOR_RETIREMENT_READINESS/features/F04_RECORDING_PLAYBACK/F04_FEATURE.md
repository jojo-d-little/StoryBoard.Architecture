...
This packet is the feature-level execution record. Its authoritative dependency order, pass catalog, and acceptance criteria are maintained in `SIMULATOR_RETIREMENT_READINESS_EXECUTION_ROADMAP.md` under F04.

## Planned Passes

1. F04.1 through F04.10.
2. Primary areas: Architecture, Contracts, Host/Engine, WebPortal, Designer, and Simulator audit.
