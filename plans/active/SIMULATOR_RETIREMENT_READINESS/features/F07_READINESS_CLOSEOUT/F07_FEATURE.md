...
This packet is the feature-level execution record. Its authoritative dependency order, pass catalog, and acceptance criteria are maintained in `SIMULATOR_RETIREMENT_READINESS_EXECUTION_ROADMAP.md` under F07.

## Planned Passes

1. F07.1 through F07.7.
2. Primary areas: Contracts, Designer, Host/Engine, WebPortal, Simulator audit, integration, and closeout.
3. Pass handoffs are instantiated in this folder when scheduled; each inherits one area profile from `../../area-profiles/`.
